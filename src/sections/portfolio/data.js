...
import Image4 from '../../assets/reserve.png'
...
const data = [
...

    {
        ...
        category: 'FullStack',
        image: Image4,
        title: "Reserve Bus (FullStack)",
        desc : "The Reserve Bus app project is a FullStack  application developed using MongoDB, Express.JS, React.Js, and Node.js. It enable user to a book a seat Online.",
        demo: 'https://borsetushar.github.io/reserve-app/',
        github: 'https://github.com/borsetushar/reserve-app.git'
    },
